...
<div style="margin:0; padding:0; width:100%; background:#f1f5f9;">
    <div style="max-width: 720px; margin: 0 auto; padding: 24px 14px;">
        <div style="background:#0f172a; border-radius: 14px; padding: 18px 18px; color:#f8fafc;">
            ...
            <div style="margin-top: 6px; color:#cbd5e1; font-weight: 700;">New booking request received</div>
        </div>
            ...
            <div style="padding: 16px 18px;">
                <div style="display:grid; grid-template-columns: 1fr; gap: 12px;">
                    <div style="background:#f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 14px;">
                        <div style="font-weight: 900; color:#0f172a;">Renter Details</div>
                        <div style="margin-top: 8px; color:#0f172a; font-weight: 700;">Name: {{ $renter?->name ?? '—' }}</div>
                        <div style="margin-top: 4px; color:#0f172a; font-weight: 700;">Email: {{ $renter?->email ?? '—' }}</div>
                        <div style="margin-top: 4px; color:#0f172a; font-weight: 700;">Address: {{ $renter?->address ?? '—' }}</div>
                    </div>
                    ...
                    <div style="background:#f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 14px;margin-top:8px">
                        ...
                        @if($rental->additional_message)
                            <div style="margin-top: 10px; color:#0f172a; font-weight: 700;">Special Instructions:</div>
                ...
                <div style="margin-top: 14px; display:flex; gap: 10px; flex-wrap: wrap;">
                    ...
                    <a href="{{ url('/client-bookings?status=Pending') }}" style="display:inline-block; background:#ffffff; color:#0f172a; text-decoration:none; font-weight: 900; padding: 12px 16px; border-radius: 10px; border: 1px solid #e2e8f0;">
                        View Pending
                    </a>
                </div>
        ...
        <div style="margin-top: 12px; color:#64748b; font-weight: 700; font-size: 0.85rem; line-height: 1.5; text-align:center;">
            This is a transactional email sent to vehicle owners for booking operations. If you believe you received this in error, contact support.
        </div>
    </div>
</div>
