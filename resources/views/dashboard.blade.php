<x-member-layout>
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 30px;">
                @foreach($bookings as $booking)
                    @php
                        ...
                        if ($displayDays == 0 && (int)($booking->extra_hours ?? 0) === 0) $displayDays = 1;
                        $days = $displayDays;
                    ...
                    @endphp
                    <div class="booking-card" x-data="{ expanded: false }" @click="if (window.innerWidth <= 768 && !$event.target.closest('button, a, input, textarea, select, label, .doc-link, .star-btn, .review-submit')) expanded = !expanded">
                        <div class="booking-header">
                            ...
                            <div class="booking-timestamp" style="display:flex; align-items:center; gap:10px;">
                                ...
                                <div class="mobile-tap-note">Tap anywhere in the card to expand/collapse</div>
                            </div>
                        </div>
    ...
    <style>
        ...
        .header-main { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; min-width: 0; }
        ...
        .booking-summary-actions { display: flex; flex-direction: column; gap: 10px; align-items: stretch; min-width: 160px; }
        ...
        @media (max-width: 768px) {
            ...
            .header-main { width: 100%; flex-direction: column; align-items: flex-start; }
                ...
                try {
                    ...
                    if (ownerId > 0 && payload?.owner) {
                        ...
                        if (badge) {
                            ...
                            const headerMain = document.querySelector('#reviewBox-' + rentalId)?.closest('.booking-card')?.querySelector('.header-main');
                            if (headerMain) {
